...
% raw
scopes(3).addsignal(getsignalid(tg,'DAQ/raw_encoder_signals/s3')); % right front leg
scopes(3).addsignal(getsignalid(tg,'DAQ/raw_encoder_signals/s4')); % right front motor
scopes(3).addsignal(getsignalid(tg,'DAQ/raw_encoder_signals/s1')); % right back leg
scopes(3).addsignal(getsignalid(tg,'DAQ/raw_encoder_signals/s2')); % right back motor
scopes(3).addsignal(getsignalid(tg,'DAQ/raw_encoder_signals/s7')); % left front leg
scopes(3).addsignal(getsignalid(tg,'DAQ/raw_encoder_signals/s8')); % left front motor
scopes(3).addsignal(getsignalid(tg,'DAQ/raw_encoder_signals/s5')); % left back leg
scopes(3).addsignal(getsignalid(tg,'DAQ/raw_encoder_signals/s6')); % left back motor
