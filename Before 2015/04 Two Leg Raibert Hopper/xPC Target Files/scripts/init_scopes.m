...
% lateral
scopes(2).addsignal(getsignalid(tg,'DAQ/raw_encoder_signals/s9')); 
scopes(2).addsignal(getsignalid(tg,'DAQ/raw_encoder_signals/s10'));
...
fscopes(4).addsignal(getsignalid(tg,'Control/Behavior Control/Primary Leg Behavior/Ts/s1'));
