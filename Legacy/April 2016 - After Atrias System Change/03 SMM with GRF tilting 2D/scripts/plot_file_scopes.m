...
inverse_dynamics_GRFx_target = controller(:,16);
inverse_dynamics_GRFy_target = controller(:,17);
inverse_dynamics_GRF_angle_target = controller(:,18);
% Flight
...
plot_fscope('Inverse Dynamics',{t,t,t}, {[GRFx_measured, inverse_dynamics_GRFx_target.*contact], [GRFy_measured, inverse_dynamics_GRFy_target.*contact], [inverse_dynamics_GRF_angle_target.*180/pi].*contact}, ...
    {{'Measured','GRFx Target'},{'Measured','GRFy Target'},{'GRF Angle Target'}},...
