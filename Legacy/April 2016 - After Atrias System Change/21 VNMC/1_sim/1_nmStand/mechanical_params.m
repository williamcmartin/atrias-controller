...
%% Initial parameters
% -------------------
initial_r_leg_length    = 0.84;
initial_r_leg_angle     = 70*pi/180 + pi/2;
initial_l_leg_length    = 0.84;
initial_l_leg_angle     = 110*pi/180 + pi/2;
ankle_initial_r         = 15*pi/180;
ankle_initial_l         = 55*pi/180;
...
initial_com_height = 0.15+initial_r_leg_length*sin(initial_r_leg_angle-pi/2);
