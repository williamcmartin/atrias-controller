...
% -------------------------------
K_ECC_discrete = sample_time/((2*mtu_tau/sample_time)+sample_time);
a_ECC_discrete = -1;
b_ECC_discrete = ((2*mtu_tau/sample_time)-sample_time)/((2*mtu_tau/sample_time)+sample_time);
...
phi12_min = 0*pi/180; %[rad]
phi12_max = 175*pi/180; %[rad]
    
phi23_max = 230*pi/180; %[rad]
phi23_min = 100*pi/180; %[rad]
