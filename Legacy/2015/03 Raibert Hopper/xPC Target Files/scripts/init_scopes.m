...
% motor torques
scopes(3).addsignal(getsignalid(tg,'Control/Behavior Control/flight'));
scopes(3).addsignal(getsignalid(tg,'Control/Behavior Control/thrust'));
scopes(3).addsignal(getsignalid(tg,'Control/Behavior Control/posture'));
scopes(3).addsignal(getsignalid(tg,'Control/Behavior Control/placement'));
% lateral
%     'YLimit', [-7 7]...
...
scopes(4).addsignal(getsignalid(tg,'Control/Behavior Control/F_vertical'));
...
fscopes(4).addsignal(getsignalid(tg,'Control/Behavior Control/Ts/s1'));
fscopes(4).addsignal(getsignalid(tg,'Control/Behavior Control/F_vertical/s1'));
fscopes(4).addsignal(getsignalid(tg,'Control/Behavior Control/dx_avg/s1'));
fscopes(4).addsignal(getsignalid(tg,'Control/Behavior Control/Leg Placement Torque/phi_desired/s1'));
fscopes(4).addsignal(getsignalid(tg,'Control/Behavior Control/flight'));
fscopes(4).addsignal(getsignalid(tg,'Control/Behavior Control/thrust'));
fscopes(4).addsignal(getsignalid(tg,'Control/Behavior Control/posture'));
fscopes(4).addsignal(getsignalid(tg,'Control/Behavior Control/placement'));
fscopes.start();