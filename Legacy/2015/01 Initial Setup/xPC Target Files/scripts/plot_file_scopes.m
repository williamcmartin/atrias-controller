...
plot_fscope('Leg Angle Trajectory',{t,t}, {cont.data(:,1:2)*180/pi, cont.data(:,5:6)*180/pi},...
...
plot_fscope('Knee Angle Trajectory',{t,t}, {cont.data(:,3:4)*180/pi, cont.data(:,7:8)*180/pi},...
    {{'Desired';'Measured'},{'Desired';'Measured'}},...
