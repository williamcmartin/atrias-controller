...
% spring deflections, rb rf lb lf
...
sea_measured = bsxfun(@times, deflections, k_sea);
sea_desired = ones(length(t),4)*-suspended_mass*g*0.5;

plot_fscope('SEAs',{t,t}, {[sea_measured(:,1:2) sea_desired(:,1:2)], [sea_measured(:,3:4) sea_desired(:,3:4)]}, ...
