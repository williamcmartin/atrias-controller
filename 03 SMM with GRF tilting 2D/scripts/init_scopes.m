...
fscopes(1).addsignal(getsignalid(tg,'Control/Behavior Control/Primary Leg Behavior/Raibert Hopping/Inverse Dynamics Virtual Spring/GRFx_target/s1'));
fscopes(1).addsignal(getsignalid(tg,'Control/Behavior Control/Primary Leg Behavior/Raibert Hopping/Inverse Dynamics Virtual Spring/GRFy_target/s1'));
fscopes(1).addsignal(getsignalid(tg,'Control/Behavior Control/Primary Leg Behavior/Raibert Hopping/Inverse Dynamics Virtual Spring/GRF_angle/s1'));
% Raibert leg trajectory
fscopes(1).addsignal(getsignalid(tg,'Control/Behavior Control/Primary Leg Behavior/Raibert Hopping/leg_length_commands/s1'));
fscopes(1).addsignal(getsignalid(tg,'Control/Behavior Control/Primary Leg Behavior/Raibert Hopping/leg_length_commands/s2'));
fscopes(1).addsignal(getsignalid(tg,'Control/Behavior Control/Primary Leg Behavior/Raibert Hopping/leg_length_commands/s3'));
% Raibert stance
fscopes(1).addsignal(getsignalid(tg,'Control/Behavior Control/Primary Leg Behavior/Raibert Hopping/l_virtual_deflection/s1'));
fscopes(1).addsignal(getsignalid(tg,'Control/Behavior Control/Primary Leg Behavior/Raibert Hopping/k_virtual/s1'));
% x position
