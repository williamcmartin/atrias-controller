...
% 
% % Logic voltages
% plot_fscope(202, t, supervisory.data(:,16:19),{'backR';'frontR';'backL';'frontL'},'Logic Voltages','Time (sec)','ADC value',[0 5000]);
% 
% % Temperature
% plot_fscope(203, t, supervisory.data(:,20:25),{'1';'2';'3';'4';'5';'6'},'FrontR Motor Temperature','Time (sec)','ADC value',[0 6000]);
% plot_fscope(204, t, supervisory.data(:,26:31),{'1';'2';'3';'4';'5';'6'},'BackR Motor Temperature','Time (sec)','ADC value',[0 6000]);
